...
class CommentForm extends Component {
    ...
    render() {
        return (
            <div>
                <Button outline onClick={this.toggleModal} color="secondary"><i className="fa fa-pencil"></i> Submit
                    Comment</Button>{' '}
                <Modal isOpen={this.state.isModalOpen} toggle={this.toggleModal}>
                    ...
                    <ModalBody>
                        <LocalForm onSubmit={(values) => this.handleSubmit(values)} className="col-12">
                            ...
                            <Row className="form-group">
                                <Label htmlFor="name" model>Comment</Label>
                                <Control.textarea model=".comment" defaultValue="" name="comment" rows="6" className="form-control"/>
                            </Row>
